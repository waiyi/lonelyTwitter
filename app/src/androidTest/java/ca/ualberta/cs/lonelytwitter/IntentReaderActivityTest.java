...
public class IntentReaderActivityTest extends ActivityInstrumentationTestCase2{
    ...
    public void testDisplayText(){
     ...
     //   intent.putExtra(IntentReaderActivity.MODE_OF_TRANSFORM_KEY, "message 2");
    ...
    public void testDefaultText(){
       ...
       // intent.putExtra(IntentReaderActivity.MODE_OF_TRANSFORM_KEY,
        ...
        setActivityIntent(intent);
        IntentReaderActivity ira = (IntentReaderActivity) getActivity();
        assertEquals("The text should be default text", "default text",
                ira.getText());
    }
    //
    //
    public void testVisibleText() {
        ...
        setActivityIntent(intent);
        IntentReaderActivity ira = (IntentReaderActivity) getActivity();
        View textView = (View) ira.findViewById(R.id.intentText);
